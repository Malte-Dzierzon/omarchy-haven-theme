...
local activeBorderColor = {
  colors = { "rgba(97a6bbee)", "rgba(bfae87ee)", "rgba(83a2a3ee)" },
  angle = 45,
}
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4, bezier = "havenEase", style = "popin 92%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 2.2, bezier = "havenFade", style = "popin 92%" })
